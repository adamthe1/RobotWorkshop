...
class Preprocessing:
    ...
    def preprocess(self, packet):
        ...
        policy_item = self.convert_packet_to_dict(packet)
        return policy_item

    def convert_packet_to_dict(self, packet):
        """Convert the incoming packet to a dict.
        ...
        preprocessed_data = {}
        preprocessed_data['qpos'] = packet.qpos if packet.qpos is not None else np.zeros(7)
